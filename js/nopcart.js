...
MinimumOrderPrompt    = 'Comanda minima este de 1000 RON!';
...
function AddToCart(thisForm) {
   ...
   for ( i = 1; i <= iNumberOrdered; i++ ) {
      ...
      if ( fields[0] == strID_NUM &&
         ...
         notice = strQUANTITY + " " + strNAME + strID_NUM + strAdded;
         break;
      }
   }
...
function ManageCart( ) {
   ...
   if ( iNumberOrdered == 0 ) {
      strOutput += "<TR><TD COLSPAN=6 CLASS=\"nopentry\"><CENTER><BR><B>Cosul este gol!</B><BR><BR></CENTER></TD></TR>";
   }
   ...
   for ( i = 1; i <= iNumberOrdered; i++ ) {
      ...
      fields = new Array;
      fields[0] = database.substring( Token2+1, Token3 );          // Product Name/Description
      fields[1] = database.substring( Token0+1, Token1 );          // Quantity
      fields[2] = database.substring( Token1+1, Token2 );          // Price
      fields[3] = database.substring( 0, Token0 );                 // Product ID
      ...
      if ( bDisplay ) {
         ...
         strOutput += "<TD CLASS=\"nopentry\">"+ MonetarySymbol + moneyFormat(fields[2]) + " buc.</TD>";

         if ( DisplayShippingColumn ) {
            if ( parseFloat(fields[4]) > 0 )
               strOutput += "<TD CLASS=\"nopentry\">"+ MonetarySymbol + moneyFormat(fields[4]) + " buc.</TD>";
            else
